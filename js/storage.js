...
window.addEventListener('message', function(msg) {
  if (msg.origin === 'https://kad.arbitr.ru') {
    ...
    if (obj.key === 'storage') {
      console.log('msg:',msg);
      //console.log('obj:',obj);
      let info = obj.info !== undefined ? JSON.parse(obj.info) : '';
      console.log('%cсообщение поступило в storage.html: %o','color:#FFA812;', info); //Сообщение отправленно в storage.html
      // читать здесь
